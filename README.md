![Bastoji Logo](https://sqoin.us/coin/wp-content/uploads/2018/08/bastoji-1.jpg)
...
It is also required to have the Bastoji daemon running in the background. It is recommended to set this up before beginning to set up the explorer so that it syncs by the time you need it.

Our geniuses here at BastojiCorp™ have put together a script to do this for you. Just run

`bash script/bastojid_setup.sh`

This will install the latest Bastoji wallet and create a rpc username/password before starting the daemon.

## Install
`git clone https://github.com/sqoin/bastoji-explorer.git` - copy repo to local folder.
